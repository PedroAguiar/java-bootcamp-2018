    ...
    <table border="1" cellpadding="4">
        ...
        <c:forEach var="payment" items="${listPayment}">
            <tr>
                ...
                <td>
                    <a href="${pageContext.request.contextPath}/editPayment?id=<c:out value='${payment.idOrder}' />">Edit</a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="${pageContext.request.contextPath}/deletePayment?id=<c:out value='${payment.idOrder}' />">Delete</a>
                </td>
            </tr>
        </c:forEach>
    </table>
